...
export function getOtelDir(homeDir: string): string {
  return path.join(getHudPluginDir(homeDir), 'otel');
}

export function getSamplePath(homeDir: string, sessionId: string): string {
...
export function getPidFilePath(homeDir: string): string {
 ...
 */
export function getSpawnStatePath(homeDir: string): string {
