...
import { isProcessAlive, readPidRecord, readSettingsOtelEndpoint, resolveOtelEndpoint, resolveReceiverEntry, } from './lifecycle.js';
 ...
 */
function claimPidFile(pidPath, payload) {
...
function writePidFile(homeDir, port) {
...
if (argvPath && isSamePath(argvPath, scriptPath)) {
    ...
    const endpoint = resolveOtelEndpoint(process.env, readSettingsOtelEndpoint(homeDir, process.cwd()));
